...
| 095 | Make Provider Status and Quota History Legible | P1 | M | - | DONE (maintainer reopening D20; missing machine IDs no longer collapse labelled observations, full gates passed; awaiting independent review before program merge) |
...
| 098 | Session Drawer, Analysis, and Report Chrome Polish | P2 | M | 088 (drawer, records); 093/094 if they touched `preset.ts` | BLOCKED (dependencies 088 and 094 did not land) |
