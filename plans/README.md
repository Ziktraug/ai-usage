...
| 114 | Session Rounds and Sub-agents — Reading Panel With a URL Across Claude, Codex, and OpenCode | P1 | L | - | IN PROGRESS (branch `feat/session-rounds-panel`; phase 1 contract and derivation) |
