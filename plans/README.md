...
| 068 | Migrate Web to SvelteKit With Contract-First oRPC | P1 | L | 066, 067 | TODO |
...
- Plan 068 supersedes plan 032 only for the Web framework, Router lifecycle, and
  ...
  browser-to-Web adapter, never an engine report service. Execute its waves in
  order so transport and cache semantics stabilize before the Svelte UI cutover.
