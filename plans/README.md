...
| 098 | Session Drawer, Analysis, and Report Chrome Polish | P2 | M | 088 (drawer, records); 093/094 if they touched `preset.ts` | TODO (unblocked; execution active on `exec/098`) |
