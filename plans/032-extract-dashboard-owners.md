# Plan 032: Extract characterized Dashboard and TimeRange owners
...
- **In scope**: characterize URL/revision/focus/pointer; extract narrow owners one commit at a time; audit cognitive-complexity rule.
...
3. Run the slice-specific gates: all characterization and E2E pass after every extraction; no semantics/effect-order change. **Expected**: every named invariant is machine-checked and passes.
...
Use existing colocated Bun model tests and role-based Playwright tests as structural patterns. Add deterministic synthetic fixtures only. Required oracle: all characterization and E2E pass after every extraction; no semantics/effect-order change.
