    ...
    currentRecord(owner, {
      ...
      evidence: [
        ...
        },
        {
          ...
          kind: 'test',
          phase: 'target',
          reference: 'apps/web/src/lib/features/sources/source-components.test.ts',
        },
      ],
    ...
    currentRecord(owner, {
      ...
      evidence: [
        ...
        },
        {
          ...
          phase: 'target',
          reference:
            'apps/web/src/lib/features/sources/source-components.test.ts; apps/web/src/lib/features/sources/event-stream.server.test.ts',
        },
      ],
